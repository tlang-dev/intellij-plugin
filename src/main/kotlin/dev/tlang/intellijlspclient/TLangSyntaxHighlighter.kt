...
class TLangSyntaxHighlighter : SyntaxHighlighterBase() {
    companion object {
        val ID: TextAttributesKey = createTextAttributesKey("TLANG_ID", DefaultLanguageHighlighterColors.IDENTIFIER)
        val KEYWORD: TextAttributesKey =
            createTextAttributesKey("TLANG_KEYWORD", DefaultLanguageHighlighterColors.KEYWORD)
        val STRING: TextAttributesKey = createTextAttributesKey("TLANG_STRING", DefaultLanguageHighlighterColors.STRING)
        ...
        val COMMA: TextAttributesKey = createTextAttributesKey("TLANG_COMMA", DefaultLanguageHighlighterColors.COMMA)
        ...
        val BRACES: TextAttributesKey = createTextAttributesKey("TLANG_BRACES", DefaultLanguageHighlighterColors.BRACES)
        val DOT: TextAttributesKey = createTextAttributesKey("TLANG_DOT", DefaultLanguageHighlighterColors.DOT)
        val SIGN: TextAttributesKey =
            createTextAttributesKey("TLANG_OPERATOR_SIGN", DefaultLanguageHighlighterColors.OPERATION_SIGN)
        val NUMBER: TextAttributesKey = createTextAttributesKey("TLANG_NUMBER", DefaultLanguageHighlighterColors.NUMBER)
    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<TextAttributesKey> {
        ...
        val attrKey: TextAttributesKey = when (tokenType.antlrTokenType) {
            ...
            TLangLexer.Let -> KEYWORD
            TLangLexer.New -> KEYWORD
            TLangLexer.True -> KEYWORD

            TLangLexer.Sync -> KEYWORD
            TLangLexer.Init -> KEYWORD
            TLangLexer.Destroy -> KEYWORD
            TLangLexer.Future -> KEYWORD
            TLangLexer.Await -> KEYWORD
            TLangLexer.Try -> KEYWORD
            TLangLexer.Catch -> KEYWORD
            TLangLexer.Finally -> KEYWORD
            TLangLexer.Continue -> KEYWORD
            TLangLexer.Break -> KEYWORD
            TLangLexer.Const -> KEYWORD
            TLangLexer.Static -> KEYWORD
            TLangLexer.Setter -> KEYWORD
            TLangLexer.Getter -> KEYWORD
            TLangLexer.Factory -> KEYWORD
            TLangLexer.Constructor -> KEYWORD
            TLangLexer.Throw -> KEYWORD

            TLangLexer.False -> KEYWORD
