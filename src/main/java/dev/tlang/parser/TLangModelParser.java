...
public class TLangModelParser extends Parser {
	...
	public static final int
		...
		T__17=18, T__18=19, TEXT=20, WS=21, STRING=22, NUMBER=23, COMMENT=24, 
		LINE_COMMENT=25, Helper=26, Tmpl=27, Model=28, Use=29, Expose=30, Func=31, 
		If=32, Else=33, For=34, With=35, In=36, To=37, Until=38, Set=39, Let=40, 
		Impl=41, Ext=42, New=43, Spec=44, Pkg=45, While=46, Do=47, Var=48, Return=49, 
		True=50, False=51, LBRACE=52, RBRACE=53, LPARENT=54, RPARENT=55, LSQUARE=56, 
		RSQUARE=57, INTEPRETED=58, As=59, Sync=60, Init=61, Destroy=62, Future=63, 
		Await=64, Try=65, Catch=66, Finally=67, Continue=68, Break=69, Const=70, 
		Static=71, Getter=72, Setter=73, Factory=74, Constructor=75, Throw=76, 
		Public=77, Private=78, Protected=79, Sealed=80, Abstract=81, Trait=82, 
		Record=83, Singleton=84, ESCAPED_ID=85, WHITE_SPACES=86, ID=87;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, "TEXT", "WS", "STRING", 
	...
	public static class ModelSetEntityContext extends ParserRuleContext {
		...
		public TerminalNode LPARENT() { return getToken(TLangModelParser.LPARENT, 0); }
		public TerminalNode RPARENT() { return getToken(TLangModelParser.RPARENT, 0); }
	...
	public final ModelSetEntityContext modelSetEntity() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18016597532737544L) != 0) || _la==ID) {
				{
				setState(110);
				((ModelSetEntityContext)_localctx).modelSetAttribute = modelSetAttribute();
	...
	public static class ModelSetArrayContext extends ParserRuleContext {
		public Token array;
		public TerminalNode LSQUARE() { return getToken(TLangModelParser.LSQUARE, 0); }
		public TerminalNode RSQUARE() { return getToken(TLangModelParser.RSQUARE, 0); }
		public TerminalNode ID() { return getToken(TLangModelParser.ID, 0); }
	...
	public static class ModelSetFuncDefContext extends ParserRuleContext {
		...
		public List<TerminalNode> LPARENT() { return getTokens(TLangModelParser.LPARENT); }
		public TerminalNode LPARENT(int i) {
			return getToken(TLangModelParser.LPARENT, i);
		}
		public List<TerminalNode> RPARENT() { return getTokens(TLangModelParser.RPARENT); }
		public TerminalNode RPARENT(int i) {
			return getToken(TLangModelParser.RPARENT, i);
		}
	...
	public final ModelSetRefContext modelSetRef() throws RecognitionException {
		...
		try {
			...
			if (_la==LPARENT) {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 97955490932719624L) != 0) || _la==ID) {
					{
					setState(178);
	...
	public static class AssignVarContext extends ParserRuleContext {
		...
		public TerminalNode Let() { return getToken(TLangModelParser.Let, 0); }
		public TerminalNode ID() { return getToken(TLangModelParser.ID, 0); }
		public OperationContext operation() {
			return getRuleContext(OperationContext.class,0);
		}
	...
	public static class BoolValueContext extends ParserRuleContext {
		public TerminalNode True() { return getToken(TLangModelParser.True, 0); }
		public TerminalNode False() { return getToken(TLangModelParser.False, 0); }
		...
		try {
			...
			case 2:
				...
				if (_la==T__2) {
					{
					setState(345);
					((CallObjTypeContext)_localctx).ref = match(T__2);
					}
				}
	...
	public final EntityValueContext entityValue() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 97955490932719624L) != 0) || _la==ID) {
				{
				{
				setState(388);
